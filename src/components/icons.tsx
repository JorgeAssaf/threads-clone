export const ThreadsLogo = ({ ...props }: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      aria-label='Threads'
      fill='currentColor'
...
export const Post = ({ ...props }: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      aria-label='Create'
      role='img'
...
export const Likes = ({ ...props }: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        x='3'
        y='7'
        className=' h-[2.5px] w-[21px] rounded-md'
      ></rect>
      <rect
        rx='1.25'
        x='10'
